...
def scrape_aljazeera():
    ...
    print("Starting Al Jazeera scraper...")
    ...
    print(f"Scraped {len(data)} articles from Al Jazeera.")
    
    # Save Paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_dir = os.path.join(script_dir, "../data")
    
    json_path = os.path.join(output_dir, "data_aljazeera.json")
    txt_path = os.path.join(output_dir, "data_aljazeera.txt")
