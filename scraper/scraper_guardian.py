...
def scrape_guardian():
    ...
    print("Starting Guardian scraper...")
    ...
    print(f"Scraped {len(data)} articles from The Guardian.")
    
    # Save Paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_dir = os.path.join(script_dir, "../data")
    
    json_path = os.path.join(output_dir, "data_guardian.json")
    txt_path = os.path.join(output_dir, "data_guardian.txt")
